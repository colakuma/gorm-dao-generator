...
go install github.com/colakuma/gorm-dao-generator@latest
go env -w GOSUMDB=on
```
...
For more information, see:
        https://github.com/colakuma/gorm-dao-generator
Flags:
  -dao-dir string
...
// For more tool details, please click the link to view https://github.com/colakuma/gorm-dao-generator
// --------------------------------------------------------------------------------------------
...
import (
	...
	"errors"
	"fmt"
	modelpkg "github.com/colakuma/gorm-dao-generator/example/model"
	"gorm.io/gorm"
	"strconv"
	"strings"
)
